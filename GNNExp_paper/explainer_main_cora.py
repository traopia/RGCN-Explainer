...
def visualize_result(node_idx,masked_adj, n_hop):
    ...
    sel_masked_ver = sub_sparse_tensor(sel_masked, 0.5, low_threshold=False)
    print('sel:',sel_masked_ver)
...
class Explainer:
    ...
    def explain(self, node_idx):
        ...
        print('neighbourhood',len(neighbors),neighbors)
        breakpoint()
